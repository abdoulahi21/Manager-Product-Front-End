				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping" v-if="cart.length">
								<router-link to="/cart" class="single-icon"><i class="ti-bag"></i> <span
										class="total-count">{{ totalProducts }}</span></router-link>
							</div>
						</div>
					</div>
				</div>
